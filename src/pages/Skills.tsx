    ...
    <div className="min-h-screen bg-white pt-20 transition-colors duration-300 relative overflow-hidden">
      {/* Floating background elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-20 left-5 sm:left-10 w-48 sm:w-72 h-48 sm:h-72 bg-black/5 sm:bg-black/8 rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-40 right-5 sm:right-20 w-64 sm:w-96 h-64 sm:h-96 bg-black/5 sm:bg-black/8 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}} />
          <div className="absolute bottom-20 left-1/4 w-56 sm:w-80 h-56 sm:h-80 bg-black/5 sm:bg-black/8 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}} />
          <div className="absolute bottom-40 right-1/3 w-48 sm:w-64 h-48 sm:h-64 bg-black/5 sm:bg-black/8 rounded-full blur-3xl animate-pulse" style={{animationDelay: '6s'}} />
          
          {/* Animated geometric shapes - hidden on small screens for cleaner mobile experience */}
          <motion.div 
            className="hidden sm:block absolute top-32 right-1/4 w-4 h-4 bg-black/30 rotate-45"
            animate={{ 
              y: [0, -20, 0],
              rotate: [45, 135, 45]
            }}
          ...
          />
          <motion.div 
            className="hidden md:block absolute bottom-1/3 left-1/3 w-6 h-6 bg-black/30 rounded-full"
            animate={{ 
              x: [0, 30, 0],
              scale: [1, 1.2, 1]
            }}
          ...
          />
          <motion.div 
            className="hidden lg:block absolute top-1/2 left-20 w-3 h-12 bg-black/30 rounded-full"
            animate={{ 
              rotate: [0, 180, 360]
            }}
            transition={{ 
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
          ...
          <div className="text-center mb-16 sm:mb-20">
            <div className="relative inline-block mb-6 sm:mb-8">
              ...
              <h2 className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-black mb-4 sm:mb-6 px-4">
                Skills & Expertise
              </h2>
            </div>
            ...
            <div className="flex justify-center items-center mt-8 sm:mt-12 space-x-4 sm:space-x-8">
              <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-r from-transparent via-black to-transparent" />
              <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-black animate-pulse" />
              <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-r from-transparent via-black to-transparent" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 auto-rows-fr">
            {skillCategories.map((category, categoryIndex) => {
              const gradientColors = [
                'from-black/10 via-black/5 to-gray-500/10',
                'from-gray-800/10 via-gray-600/5 to-black/10',
                'from-black/10 via-gray-700/5 to-gray-500/10',
                'from-gray-700/10 via-black/5 to-gray-800/10',
                'from-black/10 via-gray-800/5 to-black/10'
              ];
